...
1. **Recruiter** — Evidence Matrix, Assessment Studio, interview availability and candidate comparison.
2. **Candidate A** — complete assigned assessment, observe coverage changes, self-book an interview slot.
3. **Interviewer** — open the criterion-driven kit and submit evidence-linked scorecards.
4. **Hiring Manager** — review structured feedback and complete DecisionTrace.

Do not reuse the demo password or `.local` accounts outside the seeded local/hackathon environment.
