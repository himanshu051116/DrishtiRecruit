  ...
  return <div className="grid gap-5 xl:grid-cols-[minmax(0,1.35fr)_minmax(340px,.65fr)]">
    <section className="surface-card overflow-hidden">
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-200 px-5 py-4">
        <div><p className="section-kicker">Role criteria</p><h2 className="section-heading mt-1">Evaluation criteria</h2><p className="section-description">Review the full role definition at a glance. Open a row to edit details, evidence rules, and interview guidance.</p></div>
